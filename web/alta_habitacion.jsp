                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Alta de Habitación</li>
                        </ol>      
        
        <form action="ServletAltaHabitacion" method="POST">
            <p>Datos de la habitación</p>
            <p>Número de habitación: <input type="text" name="num_habitacion"/></p>
            <p>Piso: <input type="text" name="piso"/></p>
            <p>Nombre temático: <input type="text" name="nombre"/></p>
            <p>Tipo: <select name="tipo">
                <option value="1">Single</option>
                <option value="2">Doble</option>
                <option value="3">Triple</option>
                <option value="4">Múltiple</option></select>
            <p>Precio por día ($): <input type="text" name="precio"/></p>
