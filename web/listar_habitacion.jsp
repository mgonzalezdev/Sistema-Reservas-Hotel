                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Listado de Habitaciones</li>
                        </ol>
                        <h2 class="mt-4">Listado de Habitaciones</h2>
<table class="table table-striped table-bordered" style="width:100%" id="tablaHabitaciones">
  <thead>
    <tr>
  ...
  <tbody>
      ...
      <tr>
        ...
        <td> <%= precio %> </td>
        <td> 
            <form name="btnEliminaHabitacion" action="ServletEliminaHabitacion" method="post" style="display:inline">
        ...
        <td> 
            <form name="btnModificaHabitacion" action="ServletModificaHabitacion" method="post" style="display:inline">
                <input type="hidden" name="id" value="<%=idT %>">
